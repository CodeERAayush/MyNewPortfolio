...
export const contacts: Contact[] = [
  {
    ...
    href: "mailto:dev.aayushpandey@gmail.com",
    icon: <Mail />,
  },

  {
    ...
    href: "https://twitter.com/_ayushpandey",
    icon: <TwitterIcon />,
  },
  {
    name: "Github",
    className: "bg-black hover:bg-gray-800/90",
    href: "https://github.com/CodeERAayush",
    icon: <GithubIcon />,
  },
  {
    name: "LinkedIn",
    className: "bg-black hover:bg-gray-800/90",
    href: "https://www.linkedin.com/in/aayush-pandey-a8b65b203/",
    icon: <LinkedinIcon />,
  },
];
